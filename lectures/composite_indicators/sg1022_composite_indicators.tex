...
\frame{
    ...
    \begin{itemize}
        ...
        \item should be \emph{statistically independent} of each other (want as few components as possible, don't want to double up. Though can compensate in the weighting stage),
