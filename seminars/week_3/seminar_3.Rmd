...
- Setting up Qualtrics for online survey administration

## <i class="fa fa-check"></i> Pop Quiz: Preparing a survey

- What is a **pilot** survey? Why are they important?

- What is **congnitive interviewing**? Why do you use it in survey research?

- What are **think alouds**? How do they relate to cognitive interviewing?
...
You can find out what your workding directory is with the `getwd` function. List all of the files in that directory with `list.files`, and set your working directory with `setwd`.
...
## <i class="fa fa-arrow-circle-o-up"></i> Work with example survey data
